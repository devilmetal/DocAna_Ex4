...
#         fn = "results_pv/epochs/25n_10_l_001_e" +str(epoch)+ "_r"+str(run+1)
...
#         call("java -jar -Xmx1024m NN_Tool.jar -a SIGMOID -f 784 -n 25 -o 10 -l 0.001 -e " +str(epoch)+ " train_pv.txt test_pv.txt " +fn+ "_train_output.txt " +fn+ "_test_output.txt", shell=True)
#         print "-----------------------------------------------------------------------------"
...
#         fn = "results_pv/learning_rate/25n_10_l_"+str(lr).split('.')[1]+"_e10_r"+str(run+1)
...
#         call("java -jar -Xmx1024m NN_Tool.jar -a SIGMOID -f 784 -n 25 -o 10 -l "+str(lr)+" -e 10 train_pv.txt test_pv.txt " +fn+ "_train_output.txt " +fn+ "_test_output.txt", shell=True)
#         print "-----------------------------------------------------------------------------"
